I'm an enthusiast of Browser games, and I wanted to develop a Speech Recognition game using JavaScript. I came up with some usable code, but for some reason it's not working as expected. 
When I say something for the first time, either correct or not, the code stops working and recognizing my voice. Can you help me solving this?
